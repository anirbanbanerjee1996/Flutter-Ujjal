...
import 'TrackShipment2.dart';
import 'layout_type.dart';
import 'login.dart';

class TrackShipment extends StatefulWidget {
  TrackShipment({Key key, onLayoutToggle, LayoutGroup layoutGroup}) : super(key: key);

  @override
  TrackShipmentState createState() =>TrackShipmentState();
}
class Place {
  String imageUrl;
  String name;
...
class TrackShipmentState extends State<TrackShipment> {
  int selectedIndex = 2;
        ...
        children: <Widget> [
          ...
          Wrap(
            children: <Widget>[
              ...
              RaisedButton(
                onPressed: () {},
                child: Text("Pick ups",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w600,fontSize: 12.0 ),),
                color: Colors.blue,
              ...
              RaisedButton(
                onPressed: ()async{
                   Navigator.push(
                   context,
               MaterialPageRoute(builder: (context) => TrackShipment2()),
                );
