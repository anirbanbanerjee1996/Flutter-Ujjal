...
class HomePage2 extends StatefulWidget {
  ...
  HomePage2({Key key, onLayoutToggle, LayoutGroup layoutGroup}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // FadeInImage.assetNetwork(
                ...
                //       );
                //     },
                //     child: Text("Confirm", style: TextStyle(color: Colors.white,fontWeight: FontWeight.w600,fontSize: 20.0 )),
