...
class TrackShipment2 extends StatefulWidget {
  TrackShipment2({Key key, onLayoutToggle, LayoutGroup layoutGroup}) : super(key: key);

  @override
  TrackShipment2State createState() =>TrackShipment2State();
}
class Place {
  String imageUrl;
  String name;
...
class TrackShipment2State extends State<TrackShipment2> {
  int selectedIndex = 2;
          ...
          Wrap(
            children: <Widget>[
              ...
              RaisedButton(
                  ...
                  child: Text("Pick ups",style: TextStyle(color: Colors.black,fontWeight: FontWeight.w600,fontSize: 12.0 ),),
