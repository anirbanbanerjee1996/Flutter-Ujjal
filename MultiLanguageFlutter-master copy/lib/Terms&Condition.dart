...
TC({Key key, onLayoutToggle, LayoutGroup layoutGroup}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: <Widget> [
          ListTile(
            leading: Text('T&C', style: TextStyle(color: Colors.black,fontWeight: FontWeight.w600,fontSize: 27.0)),
          ),
          Divider(),
          ListTile(
