...
class MyOrders extends StatefulWidget {
  MyOrders({Key key, onLayoutToggle, LayoutGroup layoutGroup}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: <Widget> [
          ListTile(
            leading: Text('My orders', style: TextStyle(color: Colors.black,fontWeight: FontWeight.w600,fontSize: 17.0)),
          ),
            new GestureDetector(
              onTap: ()
                async{
