...
class MyOrder extends StatefulWidget {
  MyOrder({Key key, onLayoutToggle, LayoutGroup layoutGroup}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: <Widget> [
          ListTile(
            leading: Text('My order details', style: TextStyle(color: Colors.black,fontWeight: FontWeight.w600,fontSize: 17.0)),
          ),
              ...
              new Container(
                ...
                Row(
                  ...
                  children: <Widget>[
                    new Padding(padding: new EdgeInsets.only(left: 10.0, right: 10.0,top: 20),
                        child: new CircleAvatar(radius: 40.0, backgroundImage: AssetImage("tree.jpg"))
                    ),
                    new Expanded(child: new Column(
                      children: <Widget>[
                        new Padding(padding: new EdgeInsets.only(left: 0.0, right: 0.0,top: 25),
                        ),
