...
import 'ReturningShipment2.dart';
import 'Terms&Condition.dart';
import 'layout_type.dart';
import 'login.dart';

class ReturnShipment extends StatefulWidget {
  ReturnShipment({Key key, onLayoutToggle, LayoutGroup layoutGroup}) : super(key: key);

  @override
  ReturnShipmentState createState() =>ReturnShipmentState();
}
class Place {
  String imageUrl;
  String name;
...
class ReturnShipmentState extends State<ReturnShipment> {
  int selectedIndex = 2;
        ...
        children: <Widget> [
          ...
          Wrap(
            children: <Widget>[
              ...
              RaisedButton(
                  onPressed: () {},
                  child: Text("Returning",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w600,fontSize: 12.0 ),),
                  color: Colors.blue,
              ...
              RaisedButton(
                  onPressed: () async{
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => ReturnShipment2()),
                    );

                  },
                  child: Text("Track shipped",style: TextStyle(color: Colors.black,fontWeight: FontWeight.w600,fontSize: 12.0 ),),
