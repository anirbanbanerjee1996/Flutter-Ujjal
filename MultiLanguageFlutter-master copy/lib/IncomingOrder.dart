...
class IncomingOrders extends StatefulWidget {
  IncomingOrders({Key key, onLayoutToggle, LayoutGroup layoutGroup}) : super(key: key);

  @override
  IncomingOrdersState createState() =>IncomingOrdersState();
}
class Place {
  String imageUrl;
  String name;
                      ...
                      children: <Widget>[
                        ...
                        Wrap(
                          children: <Widget>[
                            RaisedButton(
                              onPressed: () {},
                              child: Text("Confirm",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w600,fontSize: 12.0 ),),
                              color: Colors.blue,
                            ...
                            RaisedButton(
                              onPressed: () {},
                              child: Text("cancel",style: TextStyle(color: Colors.black,fontWeight: FontWeight.w600,fontSize: 12.0 ),),
