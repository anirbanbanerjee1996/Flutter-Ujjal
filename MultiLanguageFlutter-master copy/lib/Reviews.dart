...
class Reviews extends StatefulWidget {
  Reviews({Key key, onLayoutToggle, LayoutGroup layoutGroup}) : super(key: key);
                  ...
                  children: <Widget>[
                    ...
                    new Expanded(child: new Column(
                      ...
                      children: <Widget>[
                        ...
                        new Text('Syed Rajiul', style: new TextStyle(fontSize: 12.0, color: Colors.black, fontWeight: FontWeight.w400 , fontStyle: FontStyle.normal),),
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            RichText(
                              text: TextSpan(
                                children: [
                                  TextSpan(text: 'Delivered on ',style:TextStyle(color: Colors.black,fontWeight: FontWeight.w600,fontSize: 10.0 ),),

                                  TextSpan(text: ' 19/02/2021', style: TextStyle(color: Colors.green,fontWeight: FontWeight.w600,fontSize: 10.0 )),
                        ...
                        SizedBox(height: 10),
                        new Text('Note to the artist about the arrangement of the shipment', style: new TextStyle(fontSize: 10.0, color: Color.fromRGBO(0, 0, 0, .5), fontWeight: FontWeight.w500 , fontStyle: FontStyle.italic),),
                        new SizedBox(height: 7.0,),
